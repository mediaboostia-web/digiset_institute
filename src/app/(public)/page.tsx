...
export default function AccueilPage() {
  return (
    <div className="space-y-0">
      {/* 1. Hero Principal avec Image_1.jpg haute qualité & Background Flouté */}
      <section className="relative bg-brand-blue-dark text-white py-16 sm:py-20 lg:py-28 overflow-hidden">
        <div 
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-brand-orange shadow-xs">
                Lancement Officiel Septembre 2026 — Akanda, Gabon
              </div>

              <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-white drop-shadow-xs">
                L&apos;Établissement Supérieur Privé de Référence aux Métiers du Numérique
              </h1>

              <p className="text-base sm:text-lg text-slate-200 leading-relaxed font-body max-w-2xl drop-shadow-2xs">
              ...
              <div className="pt-6 border-t border-white/15 grid grid-cols-3 gap-4 text-left">
                <div>
                  <div className="font-heading text-xl sm:text-2xl font-extrabold text-brand-orange">100%</div>
                  <div className="text-xs text-slate-300">Pratique en Labo TP</div>
                </div>
                <div>
                  <div className="font-heading text-xl sm:text-2xl font-extrabold text-brand-orange">6+</div>
                  <div className="text-xs text-slate-300">Certifications Pro</div>
                </div>
                <div>
                  <div className="font-heading text-xl sm:text-2xl font-extrabold text-brand-orange">Bac+2 & Bac+3</div>
                  <div className="text-xs text-slate-300">Parcours Diplômants</div>
                </div>
              </div>
            </div>

            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border-4 border-white/20 shadow-2xl bg-slate-900 aspect-4/3 sm:aspect-16/10 lg:aspect-square group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-brand-blue-dark/90 via-transparent to-transparent flex items-end p-6">
      ...
      <section className="py-16 bg-white border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
            <div className="md:col-span-4 rounded-2xl bg-slate-50 border border-slate-200 p-8 space-y-4 shadow-xs flex flex-col justify-between">
            ...
            <div className="md:col-span-4 rounded-2xl bg-brand-blue text-white p-8 space-y-4 shadow-lg flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="flex flex-col justify-between rounded-xl bg-white p-6 border border-slate-200 shadow-xs hover:border-slate-300 hover:shadow-md transition-all">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-slate-900 px-4 py-2.5 text-xs font-bold text-white hover:bg-slate-800 transition-colors"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="space-y-3 pt-2 text-xs text-slate-700">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-50 border border-slate-200 shadow-2xs">
            ...
            <div className="lg:col-span-7">
              <div className="rounded-2xl border border-slate-300 bg-white p-2 shadow-md overflow-hidden">
                <div className="relative w-full h-[360px] rounded-xl overflow-hidden bg-slate-100 border border-slate-200">
                  <iframe
                ...
                <div className="p-3 text-center bg-slate-50 flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-700">📍 Angondje, Carrefour Moussavou, Akanda</span>
                  <a
