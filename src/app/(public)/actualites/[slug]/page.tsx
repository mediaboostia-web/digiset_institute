...
export default function ArticleDetailPage({
  ...
  useEffect(() => {
    async function loadArticle() {
      ...
      // 1. Recherche dans le cache local du navigateur (localStorage v2 & v1)
      ...
      // 2. Recherche dans les données initiales du projet
      ...
      // 3. Interrogation de l'API distante /api/news
      try {
